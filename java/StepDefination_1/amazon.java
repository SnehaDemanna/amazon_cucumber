...
public void click_on_having_desired_product(String element) 
{
    ...
    @And("user navigate to \"(.*)\" page and check if \"(.*)\" is present")
    public void navigate(String url,String ispresent)
    {
		driver.get(url);
    	Assert.assertTrue(driver.findElement(By.id(ispresent)).isDisplayed());
    }
    @And("type the product \"(.*)\" in \"(.*)\"$")
    public void type_product(String product, String element)
    {
    	driver.findElement(By.id(element)).sendKeys(product);
    }
    		
    @And("click on \"(.*)\" element and if \"(.*)\" element is present")
    public void click_on_search(String element, String ispresent )
    {
    	driver.findElement(By.id(element)).click();
		String ActualText = driver.findElement(By.className(ispresent)).getText();
		Assert.assertEquals(ActualText ,"RESULTS");
    }
    ...
    @Then("click on the \"(.*)\" having desired product")
    public void click_on_desired(String element)
    {
    	driver.findElement(By.cssSelector(element)).click();
    }
