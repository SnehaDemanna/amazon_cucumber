...
public class amazonAddToCart_2 extends actionDriver2{
	...
	public void user_navigates_to_page(String string) throws IOException, ParseException, bsh.ParseException 
	{
	...
	public void check_if_is_present(String string) throws IOException, ParseException, bsh.ParseException 
	{
	    String element = (String) object.fileRead().get(string);
	...
	public void type_product_in(String string, String string2) throws IOException, ParseException, bsh.ParseException 
	{
	...
	public void click_on_the_element_and_check_if_element_is_present(String string, String string2) throws IOException, ParseException, bsh.ParseException 
	{
	...
	public void click_on_having_desired_product(String string) throws IOException, ParseException, bsh.ParseException 
	{
	    String element = (String) object.fileRead().get(string);
	...
	public void check_if_is_present_as(String string, String string2) throws IOException, ParseException, bsh.ParseException 
	{
	    String element = (String) object.fileRead().get(string);
	...
	public void click_on_and_change_the_quantity_to(String string, String string2) throws IOException, ParseException, bsh.ParseException 
	{
	    String element = (String) object.fileRead().get(string);
	...
	@And("Click on {string}")
	public void click_on(String string) throws IOException, ParseException, bsh.ParseException 
	{
	    String element = (String) object.fileRead().get(string);
		click_button(element);
	}
	...
	public void check_if_element_is_present(String string) throws IOException, ParseException, bsh.ParseException
	{
	    String element = (String) object.fileRead().get(string);
		assert_element(element);;
	}
